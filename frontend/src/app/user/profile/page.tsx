    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex flex-wrap items-center gap-5">
          <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-linear-to-br from-violet-500 to-purple-600 text-2xl font-black text-white shadow-lg shadow-violet-500/25">
            {initials}
          </div>
          <div className="min-w-0 flex-1">
            <p className="text-xl font-bold text-slate-900 truncate">{user?.fullName || 'Utilisateur'}</p>
      ...
      <section className="overflow-hidden rounded-2xl border border-red-100 bg-white shadow-sm">
        <div className="flex items-center gap-3 border-b border-red-50 px-6 py-4">
          <div className="flex h-8 w-8 items-center justify-center rounded-xl border border-red-100 bg-red-50">
            <Trash2 className="h-4 w-4 text-red-500" />
          </div>
          <div>
            <h2 className="text-base font-bold text-slate-900">Zone de danger</h2>
