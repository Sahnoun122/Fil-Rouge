...
const userIcon = (
  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M21.5 11a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z"
    />
  </svg>
);
...
export const userNavigation: NavigationItem[] = [
  ...
  { name: 'Mes Stratégies', href: '/user/strategies', icon: strategiesIcon },
  { name: 'SWOT', href: '/user/swot', icon: analyticsIcon },
  { name: 'Planning contenu', href: '/user/content-planning', icon: planningIcon },
  { name: 'Calendrier', href: '/user/calendar', icon: calendarIcon },
  { name: 'Export PDF', href: '/user/export', icon: exportIcon },
];

export const adminNavigation: NavigationItem[] = [
  { name: 'Dashboard', href: '/admin/dashboard', icon: dashboardIcon },
  { name: 'Utilisateurs', href: '/admin/users', icon: userIcon },
  { name: 'Stratégies', href: '/admin/strategies', icon: strategiesIcon },
  { name: 'Statistiques', href: '/admin/analytics', icon: analyticsIcon },
