...
const BARS = [
  { label: 'Brand Positioning', pct: 90, color: 'from-violet-500 to-purple-500' },
  { label: 'SWOT Analysis', pct: 75, color: 'from-emerald-400 to-teal-500' },
  { label: 'Content Calendar', pct: 85, color: 'from-amber-400 to-orange-500' },
  { label: 'Channel Strategy', pct: 60, color: 'from-pink-400 to-rose-500' },
];

const STATS = [
  { icon: Target, label: 'Strategies', value: '3', color: 'bg-violet-50 text-violet-600' },
  { icon: CalendarDays, label: 'Posts Planned', value: '24', color: 'bg-sky-50 text-sky-600' },
  { icon: BarChart3, label: 'Insights', value: '12', color: 'bg-emerald-50 text-emerald-600' },
];
...
const Hero = () => {
  return (
    <section className="relative overflow-hidden bg-white pt-28 sm:pt-32 pb-20 lg:pb-28">
      ...
      <div className="pointer-events-none absolute inset-0 bg-linear-to-b from-white/0 via-white/60 to-white" />
      {/* Glow blobs */}
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
            ...
            <h1 className="text-[2.6rem] sm:text-5xl xl:text-[3.5rem] font-black text-slate-900 leading-[1.06] tracking-tight max-w-xl mx-auto lg:mx-0">
              ...
              <span className="relative inline-block">
                <span className="relative z-10 bg-linear-to-r from-violet-600 via-purple-600 to-fuchsia-500 bg-clip-text text-transparent">
                  Marketing Strategy
                </span>
            ...
            <p className="mt-6 text-base sm:text-lg text-slate-500 leading-relaxed max-w-md mx-auto lg:mx-0">
              Generate a complete marketing strategy, SWOT analysis, and content calendar automatically.
              Built for marketers, startups, and businesses.
            </p>
            ...
            <div className="mt-8 flex flex-wrap gap-3 justify-center lg:justify-start">
              <Link
                href="/register"
                className="inline-flex items-center gap-2 px-6 py-3 text-sm font-bold text-white rounded-xl bg-linear-to-br from-violet-600 to-purple-600 hover:from-violet-700 hover:to-purple-700 shadow-lg shadow-violet-300/50 hover:shadow-violet-400/60 hover:-translate-y-0.5 transition-all"
              >
                Get Started Free
            ...
            <div className="mt-8 flex items-center gap-3 justify-center lg:justify-start">
              ...
              <div className="text-xs text-slate-500">
                <span className="font-bold text-slate-800">10,000+</span> strategies generated
              </div>
          ...
          <div className="relative mt-8 lg:mt-0">
            {/* Glow behind card */}
            <div className="absolute inset-0 -m-6 rounded-3xl bg-linear-to-br from-violet-200/40 to-purple-200/30 blur-2xl" />
            ...
            <div className="relative bg-white rounded-2xl border border-slate-200 shadow-2xl shadow-violet-100/60 overflow-hidden">
              ...
              <div className="bg-linear-to-r from-violet-600 to-purple-600 px-5 py-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-[10px] font-semibold text-violet-200 uppercase tracking-widest">Marketing Strategy</p>
            ...
            <div className="absolute -bottom-4 -left-4 bg-white rounded-2xl shadow-xl border border-slate-100 px-3.5 py-2.5 flex items-center gap-2.5">
              ...
              <div>
                <p className="text-xs font-bold text-slate-900 leading-none">Strategy Ready!</p>
                <p className="text-[10px] text-slate-400 mt-0.5">Generated in 2 min 14s</p>
              </div>
            </div>
            ...
            <div className="absolute -top-4 -right-4 bg-white rounded-2xl shadow-xl border border-slate-100 px-3.5 py-2.5 flex items-center gap-2.5">
              ...
              <div>
                <p className="text-xs font-bold text-slate-900 leading-none">+38% Reach</p>
                <p className="text-[10px] text-slate-400 mt-0.5">vs last quarter</p>
              </div>
            </div>
          </div>
        </div>
