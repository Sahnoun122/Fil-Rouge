  ...
  return (
    <section className="py-24 lg:py-32 bg-white relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
        {/* Big centered card */}
        <div className="max-w-4xl mx-auto rounded-3xl bg-linear-to-br from-violet-600 via-violet-700 to-purple-700 p-1 shadow-2xl shadow-violet-300/30">
          <div className="rounded-[22px] bg-linear-to-br from-violet-600 via-violet-700 to-purple-800 px-8 py-14 sm:px-16 text-center relative overflow-hidden">
            {/* Inner blobs */}
            ...
            <div className="relative">
              ...
              <p className="mt-6 text-lg text-violet-200 leading-relaxed max-w-2xl mx-auto">
                MarketPlan IA transforms your ideas into a structured, actionable marketing strategy
                in minutes — complete with SWOT analysis and content calendar.
              </p>
